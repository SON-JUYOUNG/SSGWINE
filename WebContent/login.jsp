      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 p-b-30">
               ...
               <form action = "Login" method = "post" class="wrap-form-reservation size22 m-l-r-auto">
                  <div class="row">
                     <div class="col-md-4">
                        <!-- Date -->
                        <!-- <span class="txt9">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                           <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="id" placeholder="ID">
                        </div>
                     </div>
